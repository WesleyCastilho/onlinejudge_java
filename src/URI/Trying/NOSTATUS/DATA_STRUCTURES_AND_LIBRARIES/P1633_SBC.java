...
public class P1633_SBC {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File inputFile = new File("src/URI/Trying/NOSTATUS/DATA_STRUCTURES_AND_LIBRARIES/input/P1633_input.txt");
        File outputFile = new File("src/URI/Trying/NOSTATUS/DATA_STRUCTURES_AND_LIBRARIES/output/P1633_output.txt");
